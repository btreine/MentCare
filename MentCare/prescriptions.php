	...
	$lastName = $patientName['userLastName']; 
		...
		<div class="row">
  		<div class="leftcolumn">
    		<div class="card">
      		<h2>Prescriptions</h2>
		<h4>Please review your medications, and verify that the list is up to date.<p style="color:red;">Call 911 if you have an emergency.</h4></h4>
		<p><br> There are no medications listed at this time.</p>
    		</div>
  		</div>
